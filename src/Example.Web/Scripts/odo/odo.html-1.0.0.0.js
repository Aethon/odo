...
_resources['DivaSelectorTemplate_htm'] = '<table cellspacing="0" cellpadding="0">\n' +
 ...
 '<tr><td rowspan="2"><div local-id="selected" style="width: 200px; height: 250px; position: relative" tabindex="0"></div></td><td></td><td><input local-id="filterText" type="text" tabindex="0" /></td></tr>\n' +
 '<tr>\n' +
 '    <td>\n' +
 ...
 '    </td>\n' +
 '    <td><div local-id="available" style="width: 200px; height: 250px; position: relative" tabindex="0"></div></td>\n' +
 '</tr>\n' +
 '</table>\n' +
'';
...
_resources['ExpertSelectorTemplate_htm'] = '<div style="-khtml-user-select: none; -moz-user-select: none;">\n' +
 ...
 '<tr><td><span data-bind="text: numberSelected"></span>&nbsp;selected</td><td></td><td><span data-bind="text: numberAvailable"></span>&nbsp;available</td></tr>\n' +
 '<tr><td rowspan="2"><div local-id="selected" class="initial-focus" style="width: 200px; height: 250px" tabindex="0"></div></td><td></td><td><div local-id="filterPlace"></div></td></tr>\n' +
 '<tr>\n' +
 '    <td>\n' +
 '        <button local-id="select" type="button" style="display: block" data-bind="enable: canSelect, click: selectFocused" data-button="{ icons: { primary: \'ui-icon-triangle-1-w\' }, text: false }">Add</button>\n' +
 '        <button local-id="unselect" type="button" style="display: block" data-bind="enable: canUnselect, click: unselectFocused" data-button="{ icons: { primary: \'ui-icon-triangle-1-e\' }, text: false }">Remove</button>\n' +
 '    </td>\n' +
 '    <td><div local-id="available" style="width: 200px; height: 250px" tabindex="0"></div></td>\n' +
 '</tr>\n' +
 '</table>\n' +
 '</div>\n' +
 '</div>\n' +
...
_resources['FilteredReverseDivaSelectorTemplate_htm'] = '<table cellspacing="0" cellpadding="0">\n' +
 ...
 '<tr><td><div local-id="filterPlace" style="display:none"><select local-id="filterdrop" data-bind="options: _divaFilter.categories, optionsText: \'Name\', optionsValue: \'Code\'"></select></div></td><td></td><td rowspan="2"><div local-id="selected" id="selected" tabindex="0" style="position: relative"></div></td></tr>\n' +
 '<tr>\n' +
 '    <td><div local-id="available" id="available" tabindex="0" style="position: relative"></div></td>\n' +
...
_resources['FilteredUniqueReverseDivaSelectorTemplate_htm'] = '<table cellspacing="0" cellpadding="0">\n' +
 '<tr><td><span data-bind="text: numberAvailable"></span>&nbsp;available</td><td></td><td><span data-bind="text: numberSelected"></span>&nbsp;selected</td></tr>\n' +
 '<tr><td><div local-id="filterPlace" style="display:none"><select local-id="filterdrop" data-bind="options: _divaFilter.categories, optionsText: \'Name\', optionsValue: \'Code\'"></select></div></td><td></td><td rowspan="2"><div local-id="selected" id="selected" tabindex="0" style="position: relative"></div></td><td rowspan="2" style="vertical-align: top">\n' +
...
_resources['ReverseDivaSelectorTemplate_htm'] = '<table cellspacing="0" cellpadding="0">\n' +
 '<tr><td><span data-bind="text: numberAvailable"></span>&nbsp;available</td><td></td><td><span data-bind="text: numberSelected"></span>&nbsp;selected</td></tr>\n' +
 '<tr><td><div local-id="filterPlace" style="display:none"></div></td><td></td><td rowspan="2"><div local-id="selected" id="selected" tabindex="0" style="position: relative"></div></td></tr>\n' +
 '<tr>\n' +
 '    <td><div local-id="available" id="available" tabindex="0" style="position: relative"></div></td>\n' +
 '    <td style="vertical-align: top">\n' +
 '        <button local-id="select" type="button" style="display: block; width: 35px" data-bind="enable: canSelect, click: selectFocused" data-button="{ icons: { primary: \'ui-icon-triangle-1-e\' }, text: false }">Add</button>\n' +
